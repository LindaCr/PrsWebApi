...
namespace PrsWebApi.Controllers
{
    ...
    public class UsersController : ControllerBase
    {
        ...
        public UsersController(PrsWebApiAppDbContext context)
        {
            _context = context;
        }
        ...
        {                              
            var login = await _context.Users.SingleOrDefaultAsync(u => u.Username == user.Username && u.Password == user.Password);
            if (user == null)
            {
                return NotFound();
            }
